...
def create_flow_template():
    ...
    dv_equip = DataValidation(
        type="list",
        formula1='"R-101,R-102,R-103,R-104,R-105,F-101,F-102,F-201,C-101,C-201"',
        showDropDown=False,
    )
    dv_equip.sqref = "G4:G100"
    ws.add_data_validation(dv_equip)

    # サンプルデータ (工程番号, 工程名, 操作タイプ, 前工程, 時間決定, 手動時間, 機器Tag, 担当者, 備考)
    sample_rows = [
        (1, "原料仕込み",    "CHARGE",      "",  "手動", 30,  "R-102",  "担当A", "溶剤・原料を仕込む"),
        (2, "加熱昇温",      "HEAT",        "1", "計算", "",  "R-102",  "担当A", "目標温度まで昇温"),
        (3, "反応",          "REACTION",    "2", "手動", 120, "R-102",  "担当A", "撹拌反応"),
        (4, "冷却",          "COOL",        "3", "計算", "",  "R-102",  "担当B", "冷却水で冷却"),
        (5, "晶析",          "OTHER",       "4", "手動", 60,  "R-102",  "担当B", "自然冷却晶析"),
        (6, "ろ過",          "FILTER",      "5", "計算", "",  "F-102",  "担当B", "加圧ろ過"),
        (7, "洗浄",          "WASH",        "6", "手動", 30,  "F-102",  "担当B", "洗液3回"),
        (8, "濃縮",          "CONCENTRATE", "7", "手動", 90,  "R-103",  "担当C", "溶媒回収"),
